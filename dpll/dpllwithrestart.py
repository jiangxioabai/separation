...
def backtracking_with_strategy(
    ...
    print(f"Decision {global_decision_id}: choose variable {variable} with strategy {strategy}")
...
def main():
    ...
    parser.add_argument("--max-decisions", type=int, default=100000,
                        help="Max number of decisions before giving up (default=100000)")
    ...
    print(f"c Total decisions: {final_decisions}")
